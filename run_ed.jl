...
ED_mod, ED_P_opt, ED_P_R_opt, ED_P_R_opt_dist, ED_P_S_opt, ED_D_S_opt,
	ED_L_S_opt, ED_price = EconomicDispatch(dayslicer(timeperiod)[1], nodes, pp, res, storages)
...
for hours in dayslicer(timeperiod)[2:end]
	...
	println()
	println()
	println("Calculting economic dispatch: " * string(hours))

	global ED_mod, ED_P_opt, ED_P_R_opt, ED_P_R_opt_dist, ED_P_S_opt, ED_D_S_opt,
		ED_L_S_opt, ED_price = EconomicDispatch(hours_extended, nodes, pp, res, storages,
